 ...
 <aside>
     <div id="sidebar" class="nav-collapse ">
         ...
         <ul class="sidebar-menu" id="nav-accordion">
             ...
             <li class="">
                 <a class="active" href="<?= base_url("userbiasa/profile") ?>">
 ...
 <div class="modal fade" id="editPassword" tabindex="-1" role="dialog" aria-labelledby="modalTKelas" aria-hidden="true">
     <div class="modal-dialog">
         <div class="modal-content">
             ...
             <div class="">
                 <form action="<?= base_url('userbiasa/edit_passwordku') ?>" method="post">
             ...
             <div class="col-lg-12">
                 ...
                 <div class="col-lg-8">
                     <div class="custom-box">
                         ...
                         <!-- <form role="form" method="post" action="<?= base_url("userbiasa/edit_profileku") ?>" class="form-horizontal"> -->
                         <?= form_open_multipart("userbiasa/edit_profileku") ?>
                         <div class="form-group">
