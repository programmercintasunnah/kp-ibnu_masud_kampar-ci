     ...
     <div id="sidebar" class="nav-collapse ">
         ...
         <ul class="sidebar-menu" id="nav-accordion">
             ...
             <li class="sub-menu">
                 ...
                 <ul class="sub">
                     <li class=""><a href="<?= base_url("userbiasa/rekap_kehadiran") ?>">Rekap Kehadiran</a></li>
                     <li class="active"><a href="<?= base_url("userbiasa/rekap_jurnal") ?>">Rekap Jurnal</a></li>
                 </ul>
             </li>
         </ul>
         <!-- sidebar menu end-->
                             ...
                             <div id="data_hi" class="tab-pane active">
                                 <div class="row">
                                     <div class="col-md-12">
                                             ...
                                             <div class="modal fade" id="modalIsiJurnal" tabindex="-1" role="dialog" aria-labelledby="modalTKelas" aria-hidden="true">
                                                 <div class="modal-dialog">
                                                     <div class="modal-content">
                                                         ...
                                                         <div class="">
                                                             <form action="<?= base_url('userbiasa/mulai_jurnal_modal') ?>" method="post">
                                         ...
                                         <div class="col-md-2">
                                             <br><br>
                                             <a href="<?= base_url("userbiasa/pdf_rekapjurnalku") ?>" class="btn btn-danger"><i class="fa fa-file-text"></i> Export PDF</a>
                                         </div>
                                         ...
                                         <div class="modal fade" id="modalJurnalSelesai" tabindex="-1" role="dialog" aria-labelledby="modalTKelas" aria-hidden="true">
                                             <div class="modal-dialog">
                                                 <div class="modal-content">
                                                     ...
                                                     <!-- <div class="modal-body"> -->
                                                     <div class="">
                                                         <form action="<?= base_url('userbiasa/selesai_jurnal_modal') ?>" method="post">
